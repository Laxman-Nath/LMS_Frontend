...
export const Input = ({ label, type, id, name, error, register,showPassword,togglePasswordVisibility }) => {
   ...
   return (
      ...
      >
        ...
        <input
          ...
          name={name}
          id={id}
          className=" h-15 text-sm border-2 border-black rounded-md outline-none p-2 hover:scale-90 transition-all ease-in-out duration-[1200ms] w-[70%]"
          {...register}
        />
        {type === "password" && 
         <ShowHidePassword
